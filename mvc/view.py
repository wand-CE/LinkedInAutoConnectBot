...
class Bot(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.email = customtkinter.CTkEntry(self.principal, font=(
            'Arial', self.font_size), placeholder_text='Your E-mail')
        self.email.place(x=self.position_x, y=60, w=375)

        self.password = customtkinter.CTkEntry(self.principal, font=(
            'Arial', self.font_size), show='*', placeholder_text='Your Password')
        ...
        self.profession = customtkinter.CTkEntry(
            self.principal, font=('Arial', self.font_size))
        ...
        self.optionmenu = customtkinter.CTkOptionMenu(
            self.principal, values=[f"{i}" for i in range(1, 51) if not i % 5])
    ...
    def connection_screen(self):
        ...
        # print(help(customtkinter.CTkToplevel))
        ...
        message = customtkinter.CTkTextbox(
            janela_secundaria, font=('Arial', self.font_size))
        message.pack( padx=10, pady=5, fill=customtkinter.BOTH, expand=1)
        stop = customtkinter.CTkButton(janela_secundaria, text='STOP', font=('Arial', self.font_size), fg_color="red",
                                       hover_color="darkred", command=lambda: [self.controller.loggin_out()])
        stop.pack(padx=10, pady=5)
